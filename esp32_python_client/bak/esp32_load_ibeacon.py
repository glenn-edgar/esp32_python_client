...
from libs.esp32_ibeacon import ESP32_IBEACON_MANAGER
...
if __name__ == "__main__": 
   ...
   ibeacon_manager = ESP32_IBEACON_MANAGER(esp_serial)
   ...
   while(1):
    ...
    if esp_serial.packet_recieved == True:
        ...
        time.sleep(.3)
        ibeacon_manager.write_ibeacon_setup("esp32_switches  ")
        time.sleep(1)
